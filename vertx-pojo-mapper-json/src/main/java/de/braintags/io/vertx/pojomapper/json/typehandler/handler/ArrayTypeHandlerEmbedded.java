...
/**
 * An implementation of {@link ITypeHandler} which handles Arrays which are annotated to be {@link Embedded}
 * 
...
public class ArrayTypeHandlerEmbedded extends ArrayTypeHandler {
   ...
   */
  public ArrayTypeHandlerEmbedded(ITypeHandlerFactory typeHandlerFactory) {
  ...
  public short matches(IField field) {
    if (field.isArray() && field.hasAnnotation(Embedded.class))
      return MATCH_MAJOR;
