...
* `link:../../apidocs/de/braintags/vertx/jomnigate/observer/ObserverEventType.html#BEFORE_SAVE[BEFORE_SAVE]` +
...
* `link:../../apidocs/de/braintags/vertx/jomnigate/observer/ObserverEventType.html#AFTER_SAVE[AFTER_SAVE]` +
