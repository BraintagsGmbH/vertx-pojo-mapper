...
instance of `link:../../apidocs/de/braintags/vertx/jomnigate/mapping/IField.html[IField]`, where the field and its behaviour regarding the
...
`link:../../apidocs/de/braintags/vertx/jomnigate/mapping/IField.html[IField]` and from there used, when a value is read from or shall be
