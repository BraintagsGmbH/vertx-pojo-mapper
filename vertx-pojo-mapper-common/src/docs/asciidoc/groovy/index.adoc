...
==== Encryption
By using the annotation `link:../../apidocs/de/braintags/io/vertx/pojomapper/annotation/field/Encoder.html[@Encoder]` you can encrypt field
...
`link:../../apidocs/de/braintags/io/vertx/pojomapper/annotation/field/Encoder.html[@Encoder]`, which is getting the name of the encoder as
reference. Each datastore integrates one decoder by default,
`link:../../apidocs/de/braintags/io/vertx/util/security/crypt/impl/StandardEncoder.html[StandardEncoder]` with the name StandardEncoder, which we are
referencing here. If you want to add another encoder, you can do that by modifying the
`link:../../apidocs/de/braintags/io/vertx/pojomapper/init/DataStoreSettings.html[DataStoreSettings]` by adding an instance of
`link:../../apidocs/de/braintags/io/vertx/pojomapper/init/EncoderSettings.html[EncoderSettings]`
...
Currently there are existing three implementations of `link:../../apidocs/de/braintags/io/vertx/pojomapper/mapping/IKeyGenerator.html[IKeyGenerator]`:
...
use `link:../../apidocs/de/braintags/io/vertx/pojomapper/annotation/KeyGenerator.html#NULL_KEY_GENERATOR[KeyGenerator.NULL_KEY_GENERATOR]` as value to define, that no
