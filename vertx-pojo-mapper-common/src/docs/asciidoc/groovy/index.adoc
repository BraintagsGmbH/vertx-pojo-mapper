...
`link:../../apidocs/de/braintags/vertx/jomnigate/versioning/IMapperVersion.html[IMapperVersion]`, otherwise the initialization of the mapper will fail.
...
The annotation `link:../../apidocs/de/braintags/vertx/jomnigate/annotation/VersionConverterDefinition.html[@VersionConverterDefinition]` declares the
