...
import de.braintags.io.vertx.pojomapper.testdatastore.typehandler.TypeHandlerTestSuiteEmbedded;
import de.braintags.io.vertx.pojomapper.testdatastore.typehandler.TypeHandlerTestSuiteReferenced;
...
@SuiteClasses({ TestBaseTest.class, TestSimpleInsert.class, TestSimpleMapper.class, TestSimpleMapperQuery.class,
    TestOnlyIdMapper.class, TypeHandlerTestSuite.class, TypeHandlerTestSuiteEmbedded.class,
