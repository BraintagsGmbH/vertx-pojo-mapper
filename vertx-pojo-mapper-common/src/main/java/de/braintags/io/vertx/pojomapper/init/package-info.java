 ...
 * {@link de.braintags.io.vertx.util.pojomapper.init.DataStoreSettings}, which you can simply store as
 * a local file.
 * 
 * [source, java]
 * ----
 ...
 * ----
 * In this example first the {@link de.braintags.io.vertx.util.pojomapper.init.DataStoreSettings} are loaded from a local
 * file. Afterwards the {@link de.braintags.io.vertx.util.pojomapper.init.IDataStoreInit} is instantiated and then the
 * method IDataStoreInit#initDataStore is called.
 * This method uses the {@link java.util.Properties}, which are defined inside the
 * {@link de.braintags.io.vertx.util.pojomapper.init.DataStoreSettings#getProperties()} to create a suitable IDataStore.
 * The possible properties to be set are defined inside the appropriate implementation of
 * {@link de.braintags.io.vertx.util.pojomapper.init.IDataStoreInit}, please refer to the documentation there.
 * 
 * 
 * [source, java]
 * ----
 ...
 * ----
 * This method loads the {@link de.braintags.io.vertx.util.pojomapper.init.DataStoreSettings} from a local file from a Json
