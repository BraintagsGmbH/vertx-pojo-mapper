 ...
 * constructions.
 *
 * === Initializing an IDataStore The initialization of the {@link de.braintags.io.vertx.pojomapper.IDataStore} is the
 ...
 * pojongo] to initialize an {@link de.braintags.io.vertx.pojomapper.IDataStore} which works with MongoDB.
 * 
 ...
 * 
 * [source,java] ---- {@link examples.Examples#example2()} ----
 * 
 * === Saving data
 * 
 * [source,java] ----
 ...
 * {@link de.braintags.io.vertx.pojomapper.dataaccess.write.IWrite}. By creating the IWrite the system will
 ...
 * {@link de.braintags.io.vertx.pojomapper.dataaccess.write.IWriteResult}, by which we are getting further information
 * about the action, like the generated id of the record and wether it was inserted or updated, for instance.
 * 
 * === Searching data
 * 
 * [source,java] ---- {@link examples.Examples#example4(de.braintags.io.vertx.pojomapper.IDataStore )} ----
 * 
 ...
 * {@link de.braintags.io.vertx.pojomapper.dataaccess.query.IQueryResult}, which contains several information like the
 ...
 * {@link de.braintags.io.vertx.pojomapper.dataaccess.query.IQuery} as argument. Mixing of both is not possible. In the
 * current example we are deleting an object, which we are expecting to exist in the datastore. First we are creating an
 * {@link de.braintags.io.vertx.pojomapper.dataaccess.delete.IDelete} and add the instance to be deleted. The execution
 ...
 * {@link de.braintags.io.vertx.pojomapper.dataaccess.query.IQuery}. All records, which are fitting the arguments of the
 * query are deleted.
 *
 *
 ...
 * 
 * * {@link examples.mapper.SimpleMapper} as a very simple mapper * {@link examples.mapper.DemoMapper} as an example for
 ...
 * 
 * ==== @Property Properties of a mapper are stored inside the {@link de.braintags.io.vertx.pojomapper.IDataStore} by
 ...
 * of the given field.
 * 
 * ==== @ObjectFactory By default the {@link de.braintags.io.vertx.pojomapper.mapping.IObjectFactory} is defined inside
 * each {@link de.braintags.io.vertx.pojomapper.mapping.IMapper} by using a default implementation. If you need another
 ...
 * the {@link de.braintags.io.vertx.pojomapper.IDataStore}
 * 
 ...
 * from the {@link de.braintags.io.vertx.pojomapper.IDataStore}
 * 
...
@ModuleGen(name = "vertx-pojo-mapper-common", groupPackage = "de.braintags.io.vertx.pojomapper")
