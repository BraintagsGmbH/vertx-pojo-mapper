...
public abstract class DefaultTableInfo implements ITableInfo {
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.vertx.jomnigate.mapping.datastore.ITableInfo#getName()
   */
  @Override
   ...
   * 
   * @see
   * de.braintags.vertx.jomnigate.mapping.datastore.ITableInfo#createColumn(de.braintags.vertx.jomnigate.mapping
