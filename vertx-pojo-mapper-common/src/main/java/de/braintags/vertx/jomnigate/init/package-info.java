 ...
 * {@link de.braintags.vertx.jomnigate.init.DataStoreSettings}, which you can simply store as
 * a local file.
 * 
 * [source, java]
 * ----
 ...
 * ----
 * In this example first the {@link de.braintags.vertx.jomnigate.init.DataStoreSettings} are loaded from a local
 * file. Afterwards the {@link de.braintags.vertx.jomnigate.init.IDataStoreInit} is instantiated and then the
 * method IDataStoreInit#initDataStore is called.
 * This method uses the {@link de.braintags.vertx.jomnigate.init.DataStoreSettings#getProperties()} to create a
 * suitable IDataStore.
