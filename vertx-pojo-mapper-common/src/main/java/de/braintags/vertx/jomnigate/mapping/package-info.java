 ...
 * 
 * When you are creating an {@link de.braintags.vertx.jomnigate.dataaccess.query.IQuery} for instance, the system
 ...
 * 
 * ==== Mapper
 * The result of the mapping process is an {@link de.braintags.vertx.jomnigate.mapping.IMapper}, which is created by
 ...
 * {@link de.braintags.vertx.jomnigate.mapping.datastore.IColumnHandler}, from which the suitable instance is stored
 * inside the IField. The IColumnHandler is detected during the mapping process by requesting a suitable one from the
 * {@link de.braintags.vertx.jomnigate.mapping.datastore.ITableGenerator} used by a datastore implementation.
 * The process of creation and synchronization is performed by
 * {@link de.braintags.vertx.jomnigate.mapping.IDataStoreSynchronizer}
 *
