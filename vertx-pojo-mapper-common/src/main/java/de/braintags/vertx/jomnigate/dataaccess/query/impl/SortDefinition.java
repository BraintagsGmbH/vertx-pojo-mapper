...
public class SortDefinition<T> implements ISortDefinition<T> {
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.vertx.jomnigate.dataaccess.query.ISortDefinition#addSort(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.vertx.jomnigate.dataaccess.query.ISortDefinition#addSort(java.lang.String, boolean)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.vertx.jomnigate.dataaccess.query.ISortDefinition#isEmpty()
   */
  @Override
