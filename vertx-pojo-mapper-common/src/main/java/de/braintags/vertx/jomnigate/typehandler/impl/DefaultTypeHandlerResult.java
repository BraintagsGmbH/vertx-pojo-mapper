...
public class DefaultTypeHandlerResult implements ITypeHandlerResult {
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.vertx.jomnigate.typehandler.ITypeHandlerResult#setResult(java.lang.Object)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.vertx.jomnigate.typehandler.ITypeHandlerResult#getResult()
   */
  @Override
