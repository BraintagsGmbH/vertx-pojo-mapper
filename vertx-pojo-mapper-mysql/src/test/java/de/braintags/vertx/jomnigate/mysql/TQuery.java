...
public class TQuery {
  ...
  public void test() {
    ...
    query.setSearchCondition(ISearchCondition.and(ISearchCondition.isEqual("name", "peter"),
        ISearchCondition.in("secName", "eins", "zwei"), ISearchCondition.isEqual("weight", 15)));
