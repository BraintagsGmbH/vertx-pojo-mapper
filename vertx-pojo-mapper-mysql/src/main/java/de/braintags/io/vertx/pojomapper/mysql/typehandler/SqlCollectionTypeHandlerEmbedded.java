...
public class SqlCollectionTypeHandlerEmbedded extends CollectionTypeHandlerEmbedded {

  /**
   * @param typeHandlerFactory
   */
  public SqlCollectionTypeHandlerEmbedded(ITypeHandlerFactory typeHandlerFactory) {
