...
public class SqlCollectionTypeHandlerReferenced extends CollectionTypeHandlerReferenced {

  /**
   * @param typeHandlerFactory
   */
  public SqlCollectionTypeHandlerReferenced(ITypeHandlerFactory typeHandlerFactory) {
