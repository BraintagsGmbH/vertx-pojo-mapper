...
public class SqlIdTypeHandler extends IdTypeHandler {
   ...
   * 
   * @see
   * de.braintags.io.vertx.pojomapper.json.typehandler.handler.IdTypeHandler#isCharacterColumn(de.braintags.io.vertx.util.
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.io.vertx.pojomapper.json.typehandler.handler.IdTypeHandler#isNumericColumn(de.braintags.io.vertx.util.
   * pojomapper.mapping.IField)
   */
  @Override
