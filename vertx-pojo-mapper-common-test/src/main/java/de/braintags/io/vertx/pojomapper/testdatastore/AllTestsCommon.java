...
@SuiteClasses({ TestBaseTest.class, TestSimpleMapper.class, TestStoreObject.class, TestQueryHelper.class,
    ...
    TypeHandlerTestSuite.class, TestMassInsert.class, TestKeyGenerator.class, TestKeyNoKeyGenerator.class,
    TestGeoSearch.class, TestEncoder.class, TestEmbeddedEntity.class, TestListExtrems.class })
