...
@Entity
@Indexes(@Index(name = "testindex", fields = { @IndexField(fieldName = "name", type = IndexType.GEO2DSPHERE) }))
public class SimpleIndexMapper extends BaseRecord {
  public String name;
   ...
   * 
   */
  public SimpleIndexMapper() {
  }

  /**
   * 
   */
  public SimpleIndexMapper(String name, String secondProperty) {
    this.name = name;
  ...
  public boolean equals(Object o) {
    SimpleIndexMapper compare = (SimpleIndexMapper) o;
