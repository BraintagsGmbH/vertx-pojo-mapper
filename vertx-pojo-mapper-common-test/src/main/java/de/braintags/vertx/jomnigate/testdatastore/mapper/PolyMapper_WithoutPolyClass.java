...
/**
 * Mapper to test polymorphism, where no {@link Entity#polyClass()} is defined
 * 
 * @author sschmitt
 * 
 */
@Entity(name = "PolyMapper_WithoutPolyClass")
public class PolyMapper_WithoutPolyClass implements IPolyMapper {
  @Id
  private String id;
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    PolyMapper_WithoutPolyClass other = (PolyMapper_WithoutPolyClass) obj;
    if (id == null) {
      if (other.id != null)
        return false;
