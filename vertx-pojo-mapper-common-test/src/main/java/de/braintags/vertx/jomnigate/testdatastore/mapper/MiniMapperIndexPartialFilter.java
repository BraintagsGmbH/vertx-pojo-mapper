...
@Indexes(@Index(name = "testindexMiniMapperIndexPartialFilter", fields = {
    @IndexField(fieldName = "name") }, options = @IndexOptions(partialFilterExpression = "{\"condition\":{\"field\":\"filter\",\"operator\":\"EQUALS\",\"value\":\"filtered\"}}")))
public class MiniMapperIndexPartialFilter {
  ...
  public MiniMapperIndexPartialFilter(boolean filter) {
