...
import de.braintags.vertx.jomnigate.testdatastore.mapper.typehandler.LocaleRecord;
...
public class LocaleTest extends AbstractTypeHandlerTest {
  ...
  protected String getExpectedTypeHandlerClassName() {
    return "de.braintags.vertx.jomnigate.json.typehandler.handler.LocaleTypeHandler";
  }
