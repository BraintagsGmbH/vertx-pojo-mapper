...
/**
 * A simple mapper with some beans properties to check basic functions
 * LET AWAY INDEXED FIELDS!!!
 *
...
@Entity
public class SimpleMapper_NO_INDEX extends BaseRecord {
   ...
   * 
   */
  public SimpleMapper_NO_INDEX() {
  }

  /**
   * 
   */
  public SimpleMapper_NO_INDEX(String name, String secondProperty) {
    this.name = name;
  ...
  public boolean equals(Object o) {
    SimpleMapper_NO_INDEX compare = (SimpleMapper_NO_INDEX) o;
