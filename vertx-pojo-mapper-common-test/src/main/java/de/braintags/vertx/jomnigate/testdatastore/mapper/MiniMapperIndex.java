...
@Entity
@Indexes(@Index(name = "testindexMiniMapper", fields = { @IndexField(fieldName = "name", type = IndexType.TEXT) }))
public class MiniMapperIndex {
  @Id
  ...
  public MiniMapperIndex() {
  }

  public MiniMapperIndex(String name) {
    this.name = name;
  }
